...
img1 = ImageTk.PhotoImage(Image.open(r"C:\Users\risha\OneDrive\Documents\Desktop\project\Restaurant billing automation\logo1.png"))
img2 = ImageTk.PhotoImage(Image.open(r"C:\Users\risha\OneDrive\Documents\Desktop\project\Restaurant billing automation\logo2.png"))
...
def additem_screen():
    ...
    def reset_home():
        user_entry.delete(0,END) # type: ignore
        pass_entry.delete(0,END)
        user_entry.focus()
...
def billing_screen():
    ...
    item_label.place(relx=.05,rely=.2)
    item_entry.place(relx=.1,rely=.2)
    
    qty_label.place(relx=.05,rely=.3)
    qty_entry.place(relx=.1,rely=.3)
